<?php
$baseurl="http://localhost/sams";
   session_start();
   include '../common/connect.php';
   if(isset($_SESSION['user_id']))
        {
          if(($_SESSION['role']=="admin")&& ($_SESSION['status']!= "Inactive"))
						{
							header("location:admin/admin_dashboard.php");
						}
						else if(($_SESSION['role'] =="teacher") && ($_SESSION['status']!= "Inactive"))
						{
...
<div class="wrapper">
	<div class="container">
		...
		<form class="form" method="post" action="<?php echo $baseurl; ?>/controller/login_validation.php" >
			...
			<button type="submit" id="login-button" name="send" value="send">Login</button>
     
 <!-- <a href="registration.php" rel="text/stylesheet">
  <input type="text" id="signup" name="signup" placeholder="sign up" disabled></a> 
		</form> -->
	</div>
