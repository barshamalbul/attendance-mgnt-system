          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="../../controller/view_single_student_attendance_controller.php">
                  <?php 
        $sid=$_GET['sid'];
        include '../../common/connect.php';
        $query="SELECT * FROM tbl_students WHERE Uid ='$sid'";
...
?>
                    ...
                    <div class="form-group">
                          <label class="bmd-label-floating">Full Name (disabled)</label>
                            <input type="text" name="uid" value="<?php echo($_GET['sid']); ?>" hidden>
