...
<!-- Navbar --><?php include '../../view/admin/navbar.php';?> <!-- End Navbar -->
      <div class="content">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
<form  name="class_selector" id="class_selector"
action="../../controller/admin/manage_schedule_controller.php" method="post">
					<div class="row">
                      <div class="col-md-6">
                    ...
                    <button type="submit" name="send" class="btn btn-primary pull-right">manage schedule</button>
