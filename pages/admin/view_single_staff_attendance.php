          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="../../controller/view_single_staff_attendance_controller.php">
                  <?php 
        $uid=$_GET['Uid'];
        include '../../common/connect.php';
...
?>
                    ...
                    <div class="form-group">
                          <label class="bmd-label-floating">Full Name (disabled)</label>
                            <input type="text" name="uid" value="<?php echo($_GET['uid']); ?>" hidden>
                          <input type="text" name="name" class="form-control" value="<?php echo($row['Uname']); ?>" readonly>
                        </div>
                      </div>
                        </div>
                  <div class="row">
