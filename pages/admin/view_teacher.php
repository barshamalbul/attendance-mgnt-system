              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <tbody>
                    <?php $sql ="SELECT * FROM `tbl_users`where role ='teacher' ORDER by Uid desc limit 10";
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="view_single_teacher_attendance.php?Uid=<?php echo($row['Uid']); ?>" class="btn btn-primary btn-round">
                  view</a>
                         </td>
                        </tr>
                        <?php } ?>
