...
<?php 
  ...
  $period="";
  $csid="";
  if((isset($_GET['day']))&&(isset($_GET['period'])))
    {
      $day=$_GET['day'];
      $period=$_GET['period'];
    }
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../../controller/admin/add_schedule_controller.php"  method="post">  
            ...
            <div class="row">
                ...
                //$j=$_SESSION['period']; ?>
                        ...
                        <option value="Select Filter">Select day</option>
                      ...
                      <div class="form-group">
                        ...
                        <option value="Select Filter">Select period</option>
